...
//	max30102_ret = HAL_I2C_Mem_Write(obj->_ui2c, MAX30102_I2C_ADDR, maddr, I2C_MEMADD_SIZE_8BIT, data, 1, 10);
	max30102_ret = max30102_writeMulti(obj, maddr, &data, 1);
	if (max30102_ret == HAL_OK)
		return true;
	else
		return false;
...
//	max30102_ret = HAL_I2C_Mem_Write(obj->_ui2c, MAX30102_I2C_ADDR, maddr, I2C_MEMADD_SIZE_8BIT, data, n, 10);
    ...
    *payload = maddr;
    ...
    max30102_ret = HAL_I2C_Master_Transmit(obj->_ui2c, MAX30102_I2C_ADDR, payload, n + 1, MAX30102_I2C_TIMEOUT);
    free(payload);
...
//	MAX30102_I2C_TIMEOUT);
	...
	max30102_ret = HAL_I2C_Mem_Read(obj->_ui2c, MAX30102_I2C_ADDR, maddr, I2C_MEMADD_SIZE_8BIT, data, 1, 10);
...
bool max30102_readMulti(max30102_t *obj, uint8_t maddr, uint8_t *data,
		uint16_t n) {
	max30102_ret = HAL_I2C_Mem_Read(obj->_ui2c, MAX30102_I2C_ADDR, maddr, I2C_MEMADD_SIZE_8BIT, data, n, 10);
