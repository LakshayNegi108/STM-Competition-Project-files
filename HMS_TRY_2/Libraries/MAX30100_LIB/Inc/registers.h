...
#ifndef MAX30100_LIB_INC_REGISTERS_H_
#define MAX30100_LIB_INC_REGISTERS_H_
 ...
 */
HAL_StatusTypeDef max30100_balance_intensities(max30100_config_t* this, float red_dc, float ir_dc);
 ...
 * @returns status of execution.
 */
HAL_StatusTypeDef max30100_write_register(max30100_config_t* this, uint8_t address, uint8_t val);
 ...
 * @returns status of execution.
 */
HAL_StatusTypeDef max30100_read_register(max30100_config_t* this, uint8_t address, uint8_t* reg);
 ...
 * @returns status of execution.
 */
HAL_StatusTypeDef max30100_read_fifo(max30100_config_t* this, max30100_fifo_t* fifo);
...
#endif /* MAX30100_LIB_INC_REGISTERS_H_ */
