...
#define MAX30100_DEFAULT_IR_LED_CURRENT         MAX30100_LED_CURRENT_27_1MA
#define MAX30100_DEFAULT_START_RED_LED_CURRENT  MAX30100_LED_CURRENT_11MA
...
#define MAX30100_DEFAULT_ACCEPTABLE_INTENSITY_DIFF      95000
...
#define MAX30100_DEFAULT_PULSE_BPM_SAMPLE_SIZE             50
...
typedef enum _max30100_mode_t {
	MAX30100_MODE_HR_ONLY = 0x02, MAX30100_MODE_SPO2_HR = 0x03
} max30100_mode_t;
 ...
 */
HAL_StatusTypeDef max30100_init(max30100_config_t *this,
		I2C_HandleTypeDef *hi2c, max30100_mode_t mode,
 ...
 * @returns status of execution.
 */
HAL_StatusTypeDef max30100_read_temperature(max30100_config_t *this,
		float *temperature);
 ...
 * @returns status of execution.
 */
HAL_StatusTypeDef max30100_set_acceptable_intense_diff(max30100_config_t *this,
		uint32_t acceptable_intense_diff);
